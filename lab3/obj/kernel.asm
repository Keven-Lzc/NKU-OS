...
ffffffffc02000b0:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000b2:	505030ef          	jal	ra,ffffffffc0203db6 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e6:	4d1030ef          	jal	ra,ffffffffc0203db6 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020010c:	21850513          	addi	a0,a0,536 # ffffffffc0204320 <etext+0x58>
void print_kerninfo(void) {
...
ffffffffc0200122:	22250513          	addi	a0,a0,546 # ffffffffc0204340 <etext+0x78>
ffffffffc0200126:	f99ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020012a:	00004597          	auipc	a1,0x4
ffffffffc020012e:	19e58593          	addi	a1,a1,414 # ffffffffc02042c8 <etext>
ffffffffc0200132:	00004517          	auipc	a0,0x4
ffffffffc0200136:	22e50513          	addi	a0,a0,558 # ffffffffc0204360 <etext+0x98>
...
ffffffffc020014a:	23a50513          	addi	a0,a0,570 # ffffffffc0204380 <etext+0xb8>
...
ffffffffc020015e:	24650513          	addi	a0,a0,582 # ffffffffc02043a0 <etext+0xd8>
...
ffffffffc020018c:	23850513          	addi	a0,a0,568 # ffffffffc02043c0 <etext+0xf8>
}
...
ffffffffc020019c:	15860613          	addi	a2,a2,344 # ffffffffc02042f0 <etext+0x28>
ffffffffc02001a0:	04e00593          	li	a1,78
ffffffffc02001a4:	00004517          	auipc	a0,0x4
ffffffffc02001a8:	16450513          	addi	a0,a0,356 # ffffffffc0204308 <etext+0x40>
void print_stackframe(void) {
...
ffffffffc02001b8:	31460613          	addi	a2,a2,788 # ffffffffc02044c8 <commands+0xd8>
ffffffffc02001bc:	00004597          	auipc	a1,0x4
ffffffffc02001c0:	32c58593          	addi	a1,a1,812 # ffffffffc02044e8 <commands+0xf8>
ffffffffc02001c4:	00004517          	auipc	a0,0x4
ffffffffc02001c8:	32c50513          	addi	a0,a0,812 # ffffffffc02044f0 <commands+0x100>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d6:	32e60613          	addi	a2,a2,814 # ffffffffc0204500 <commands+0x110>
ffffffffc02001da:	00004597          	auipc	a1,0x4
ffffffffc02001de:	34e58593          	addi	a1,a1,846 # ffffffffc0204528 <commands+0x138>
ffffffffc02001e2:	00004517          	auipc	a0,0x4
ffffffffc02001e6:	30e50513          	addi	a0,a0,782 # ffffffffc02044f0 <commands+0x100>
ffffffffc02001ea:	ed5ff0ef          	jal	ra,ffffffffc02000be <cprintf>
ffffffffc02001ee:	00004617          	auipc	a2,0x4
ffffffffc02001f2:	34a60613          	addi	a2,a2,842 # ffffffffc0204538 <commands+0x148>
ffffffffc02001f6:	00004597          	auipc	a1,0x4
ffffffffc02001fa:	36258593          	addi	a1,a1,866 # ffffffffc0204558 <commands+0x168>
ffffffffc02001fe:	00004517          	auipc	a0,0x4
ffffffffc0200202:	2f250513          	addi	a0,a0,754 # ffffffffc02044f0 <commands+0x100>
...
ffffffffc020023c:	20050513          	addi	a0,a0,512 # ffffffffc0204438 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020025e:	20650513          	addi	a0,a0,518 # ffffffffc0204460 <commands+0x70>
...
ffffffffc0200274:	180c8c93          	addi	s9,s9,384 # ffffffffc02043f0 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200278:	00005997          	auipc	s3,0x5
ffffffffc020027c:	71098993          	addi	s3,s3,1808 # ffffffffc0205988 <default_pmm_manager+0x990>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200280:	00004917          	auipc	s2,0x4
ffffffffc0200284:	20890913          	addi	s2,s2,520 # ffffffffc0204488 <commands+0x98>
        if (argc == MAXARGS - 1) {
ffffffffc0200288:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020028a:	00004b17          	auipc	s6,0x4
ffffffffc020028e:	206b0b13          	addi	s6,s6,518 # ffffffffc0204490 <commands+0xa0>
    if (argc == 0) {
ffffffffc0200292:	00004a97          	auipc	s5,0x4
ffffffffc0200296:	256a8a93          	addi	s5,s5,598 # ffffffffc02044e8 <commands+0xf8>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc020029a:	4b8d                	li	s7,3
        if ((buf = readline("")) != NULL) {
ffffffffc020029c:	854e                	mv	a0,s3
ffffffffc020029e:	6a5030ef          	jal	ra,ffffffffc0204142 <readline>
...
ffffffffc02002b0:	7d1030ef          	jal	ra,ffffffffc0204280 <strchr>
...
ffffffffc02002ca:	12ad0d13          	addi	s10,s10,298 # ffffffffc02043f0 <commands>
    if (argc == 0) {
...
ffffffffc02002d4:	783030ef          	jal	ra,ffffffffc0204256 <strcmp>
...
ffffffffc02002e8:	76f030ef          	jal	ra,ffffffffc0204256 <strcmp>
...
ffffffffc020034e:	733030ef          	jal	ra,ffffffffc0204280 <strchr>
...
ffffffffc020036a:	14a50513          	addi	a0,a0,330 # ffffffffc02044b0 <commands+0xc0>
...
ffffffffc02003aa:	1c250513          	addi	a0,a0,450 # ffffffffc0204568 <commands+0x178>
    va_start(ap, fmt);
...
ffffffffc02003c0:	12450513          	addi	a0,a0,292 # ffffffffc02054e0 <default_pmm_manager+0x4e8>
...
ffffffffc0203312:	03800593          	li	a1,56
...
ffffffffc02033a4:	04b00593          	li	a1,75
...
ffffffffc02033c4:	04c00593          	li	a1,76
...
ffffffffc02033d0:	fa5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
...
ffffffffc020372e:	991fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        }
...
ffffffffc020376e:	951fc0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0203894:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203896:	829fc06f          	j	ffffffffc02000be <cprintf>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
...
ffffffffc0203b9c:	d22fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
...
ffffffffc0203c86:	eeefc0ef          	jal	ra,ffffffffc0200374 <__panic>
...
ffffffffc0203d2c:	e48fc0ef          	jal	ra,ffffffffc0200374 <__panic>
...
ffffffffc0204162:	f5dfb0ef          	jal	ra,ffffffffc02000be <cprintf>
readline(const char *prompt) {
...
ffffffffc0204178:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020417c:	f7bfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
...
ffffffffc02041b4:	f3ffb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i ++] = c;
...
ffffffffc02041ce:	f25fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i] = '\0';
...
ffffffffc02041f8:	efbfb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            i --;
